...
@section('front_end_content')
        ...
        <div class="main-content">
            ...
            {{-- <div id="rs-popular-courses" class="rs-popular-courses style1 pt-100 pb-100 md-pt-70 md-pb-70">
                <div class="container">
                    <div class="gridFilter text-center mb-50"   id="myBtnContainer">
                        <button class="active"  onclick="filterSelection('all')">ALL</button>
                        <button  onclick="filterSelection('filter1')">SCIENCE</button>
                        <button  onclick="filterSelection('filter2')">BUSINESS</button>
                        <button  onclick="filterSelection('filter3')">HUMANITIES</button>
                        <button  onclick="filterSelection('filter4')">DIPLOMA</button>
                    </div>
                    <div class="row loadmore_parent ">
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter1">
                        ...
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter4 filter1">
                            <div class="courses-item mb-30">
                                <div class="img-part">
                        ...
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter3 filter2">
                            <div class="courses-item mb-30">
                                <div class="img-part">
                        ...
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter1 filter2">
                            <div class="courses-item mb-30">
                                <div class="img-part">
                        ...
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter2 filter4">
                            <div class="courses-item mb-30">
                                <div class="img-part">
                        ...
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter1 filter3">
                            <div class="courses-item mb-30">
                                <div class="img-part">
                        ...
                        <div class="col-lg-4 col-md-6 loadmore_child filterDiv filter1 filter4">
                            <div class="courses-item mb-30">
                                <div class="img-part">
                                    <img src="{{asset('assets/front/images/courses/6.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="pagination-area text-center mt-30 md-mt-0">
                        <p class="product-count">Showing <span class="shownLength"></span> out of <span class="listLength"></span> courses</p>
                        <div id="jq"></div>
                        <div class="productLoadMoreButton" style="display: none;">
                            <a href="javascript:;" class="showMore">Load More Our Courses</a>
                        </div>
                    </div>
                </div>
            </div> --}}
