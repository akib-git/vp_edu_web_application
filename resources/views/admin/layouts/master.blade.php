...
<head>
	...
	<!-- Morris Charts CSS -->
    <link href="{{asset("assets/admin/vendors/bower_components/morris.js/morris.css") }}" rel="stylesheet" type="text/css"/>
...
<body>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							<img class="brand-img" src="{{asset("assets/admin/images/logo.png") }}" alt="brand"/>
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right">
				<ul class="nav navbar-right top-nav pull-right">
								...
								<ul class="pa-20">
									...
									<li class="col-md-6 col-xs-12 preview-carousel">
										...
										<div class="product-carousel owl-carousel owl-theme text-center">
											<a href="#">
												<img src="{{asset("assets/admin/images/chair.jpg") }}" alt="chair">
												<span>Circle chair</span>
											</a>
											<a href="#">
												<img src="{{asset("assets/admin/images/chair2.jpg") }}" alt="chair">
												<span>square chair</span>
											</a>
											<a href="#">
												<img src="{{asset("assets/admin/images/chair3.jpg") }}" alt="chair">
												<span>semi circle chair</span>
											</a>
											<a href="#">
												<img src="{{asset("assets/admin/images/chair4.jpg") }}" alt="chair">
							...
							<li>
								<div class="streamline message-nicescroll-bar">
									...
									<div class="sl-item">
										<a href="javascript:void(0)">
											<div class="sl-avatar">
												<img class="img-responsive" src="{{asset("assets/admin/images/avatar.jpg") }}" alt="avatar"/>
											</div>
											<div class="sl-content">
					...
					<li class="dropdown auth-drp">
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="{{asset("assets/admin/images/user1.png") }}" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
												...
												<ul class="chat-list-wrap">
													<li class="chat-list">
														<div class="chat-body">
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{asset("assets/admin/images/user.png") }}" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{asset("assets/admin/images/user1.png") }}" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{asset("assets/admin/images/user2.png") }}" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{asset("assets/admin/images/user3.png") }}" alt="user"/>
																	<div class="user-data">
															...
															<a href="javascript:void(0)">
																<div class="chat-data">
																	<img class="user-img img-circle"  src="{{asset("assets/admin/images/user4.png") }}" alt="user"/>
																	<div class="user-data">
														...
														<ul class="nicescroll-bar pt-20">
															<li class="friend">
																<div class="friend-msg-wrap">
																	<img class="user-img img-circle block pull-left"  src="{{asset("assets/admin/images/user.png") }}" alt="user"/>
									...
									<div class="set-height-wrap">
										<div class="streamline message-box nicescroll-bar">
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{asset("assets/admin/images/user.png") }}" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{asset("assets/admin/images/user1.png") }}" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{asset("assets/admin/images/user2.png") }}" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{asset("assets/admin/images/user3.png") }}" alt="avatar"/>
													</div>
													<div class="sl-content">
											...
											<a href="javascript:void(0)">
												<div class="sl-item unread-message">
													<div class="sl-avatar avatar avatar-sm avatar-circle">
														<img class="img-responsive img-circle" src="{{asset("assets/admin/images/user4.png") }}" alt="avatar"/>
													</div>
													<div class="sl-content">
	...
	<script src="{{asset("assets/admin/js/simpleweather-data.js") }}"></script>
    ...
    <script src="{{asset("assets/admin/vendors/bower_components/raphael/raphael.min.js") }}"></script>
    <script src="{{asset("assets/admin/vendors/bower_components/morris.js/morris.min.js") }}"></script>
	...
	<script src="{{asset("assets/admin/js/dashboard-data.js") }}"></script>
</body>
