             ...
             <div class="card">
                <div class="bg-soft-primary">
                   <div class="row">
                      ...
                      <div class="align-self-end col-5"><img src="{{asset("assets/admin/img/profile-img.png") }}" alt="" class="img-fluid"></div>
                   </div>
                </div>
                <div class="pt-0 card-body">
                   <div class="row">
                      <div class="col-sm-4">
                         <div class="avatar-md profile-user mb-4"><img src="{{asset("assets/admin/img/profiles/avatar-05.jpg") }}" alt="" class="img-thumbnail rounded-circle img-fluid"></div>
                         <div class="d-block">
                      ...
                      <table class="table table-hover table-center mb-0">
                         ...
                         <tbody>
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/profiles/avatar-08.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/profiles/avatar-07.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/profiles/avatar-17.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/profiles/avatar-06.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/profiles/avatar-14.jpg") }}" alt="User Image"></a>
                      ...
                      <table class="table table-hover table-center mb-0">
                         ...
                         <tbody>
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/user/user.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/user/user1.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/user/user2.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/user/user3.jpg") }}" alt="User Image"></a>
                            ...
                            <tr>
                               <td>
                                  <h2 class="table-avatar">
                                     <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset("assets/admin/img/user/user4.jpg") }}" alt="User Image"></a>
